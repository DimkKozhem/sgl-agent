...
- **LLMAnalyzer** - Анализатор БД с использованием google/gemini-2.5-flash-preview-09-2025
- **SimpleAPI** - REST API на FastAPI
- **Models** - Модели данных с валидацией

## 🔧 Особенности

- ✅ **Интеграция с LLM** - использует google/gemini-2.5-flash-preview-09-2025 для анализа БД
...
#### Модели LLM:
- **Анализ**: `google/gemini-2.5-flash-preview-09-2025` - основная модель для анализа БД
...
- Модель анализа: `google/gemini-2.5-flash-preview-09-2025`
...
- **LLM**: google/gemini-2.5-flash-preview-09-2025 (анализ и оценка)
- **Валидация**: Pydantic
...
- ✅ **Интеграция с LLM** - google/gemini-2.5-flash-preview-09-2025 для анализа
